<template>
    <div>
        ...
        <navbar></navbar>
        <!--end navbar section-->
        <div class="intro-section bg-success">
                        ...
                        <div class="heading text-center">
                            ...
                            <div>
                                <a target="_blank" href="http://blog.bootcatch.com/post/vue-components-based-design-system-is-based-on-bootcatch-themes-and-vue" class="text-decoration-none">
                                 ...
                                 <a class="text-decoration-none" href="https://github.com/ajaymarathe/vue-epic-design-system/archive/master.zip" >
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-5">
                                ...
                                <div class="col-md-4">
                                    <base-card>
                                        ...
                                        <card-body>
                                            ...
                                            <base-button color="success">Go somewhere</base-button>
                                        </card-body>
                                    </base-card>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <base-card class="bg-success text-white">
                ...
                <div class="mb-5">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <base-alert class="py-3 text-white" color="secondary">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            beautiful documentation to help you out. It is based on <a href="http://www.bootcatch.com/lightly" target="_blank">Epic Theme</a>. Which is based on latest Bootstrap.</p>
