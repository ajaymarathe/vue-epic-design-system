    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ml-auto d-md-flex align-items-md-center">
                <li class="nav-item active">
                        <a  class="btn btn-light d-flex align-items-center text-success" href="https://github.com/ajaymarathe/vue-epic-design-system/archive/master.zip" >
                            <vue-fontawesome class="mr-2" icon="cloud-download" size=".8" ></vue-fontawesome>
                            download</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="https://github.com/ajaymarathe/vue-epic-design-system" target="_blank">
